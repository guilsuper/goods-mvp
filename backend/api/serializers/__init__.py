...
from api.serializers.origin_report_and_coponent_serializers import SourceComponentDraftSerializer
from api.serializers.origin_report_and_coponent_serializers import SourceComponentSerializer
