    ...
    <footer className="text-center text-white mt-auto" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
      ...
      <Container>
        <Row className="border-bottom mb-1 pb-1">
          <Col>
            <h4><a href="/our_mission" className="link-light link-offset-2 link-opacity-75 link-opacity-100-hover link-underline-opacity-0 link-underline-opacity-0-hover">{ t('common.our-mission') }</a></h4>
          </Col>
          <Col>
